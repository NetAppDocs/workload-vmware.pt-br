...
https://www.dell.com/en-us/shop/vmware/sl/rvtools["Saiba mais sobre RVTools"^]

.Passos
. Baixe e instale o RVTools 4.4.2 ou superior em https://www.dell.com/en-us/shop/vmware/sl/rvtools["Site da RVTools"^]
...
+
Consulte o capítulo sobre "parâmetros de linha de comando" no https://www.dell.com/en-us/shop/vmware/sl/rvtools["Documentação do RVTools"^] Para mais detalhes.
...
+
O centro de planejamento está visível. No centro de planejamento, você pode carregar seus dados de inventário de VMs, visualizar uploads de dados de inventário anteriores e planejar uma migração usando qualquer um dos conjuntos de dados de inventário de VMs. Em seguida, selecione *Migração para computação nativa da AWS*. A tela inicial do assistente de migração da VMware é exibida.
...
. Salve este token para prepará-lo para uso com o consultor de migração do Workload Factory.
