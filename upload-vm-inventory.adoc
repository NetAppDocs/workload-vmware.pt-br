...
+
O centro de planejamento está visível. A partir da central de planejamento, você pode carregar seus dados de inventário de VMs, visualizar carregamentos de dados de inventário anteriores e planejar uma migração usando qualquer um dos conjuntos de dados de inventário de VMs.
...
no https://www.dell.com/en-us/shop/vmware/sl/rvtools["Saiba mais sobre RVTools"^]
...
. Baixe e instale o RVTools 4.4.2 ou superior a partir do site oficial. https://www.dell.com/en-us/shop/vmware/sl/rvtools["Site da RVTools"^]
...
+
Consulte o capítulo sobre "parâmetros de linha de comando" no https://www.dell.com/en-us/shop/vmware/sl/rvtools["A documentação do RVTools está localizada na seção Recursos."^] Para mais detalhes.
...
* link:launch-migration-advisor-gcve.html["Crie um plano de implantação do Google Cloud VMware Engine"]
