...
* <<Create a deployment plan based on an existing plan,Para implantar um sistema na nuvem com base em um plano de implantação existente que tenha requisitos semelhantes.>>
