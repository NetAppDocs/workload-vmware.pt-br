...
Ao migrar para a VMware Cloud, você pode usar o assistente de migração para migrar seu ambiente vSphere local atual para a VMware Cloud.
...
* Você deve ter acesso ao arquivo de inventário do sistema no qual está efetuando login no Workload Factory.
...
. Selecione *Planejar e criar VMC*.
. Selecione o tipo de arquivo de inventário que você usará para preencher o Workload Factory com sua configuração de VM atual e selecione *Avançar*.
+
