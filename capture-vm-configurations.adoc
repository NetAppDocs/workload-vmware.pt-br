...
. No menu da VMware, selecione *Avaliar e planejar* e, em seguida, selecione *Migração para o VMware Cloud on AWS*.
+
A página principal do VMware Migration Advisor é exibida.

. Selecione *Planejar e criar VMC*.
. Selecione *Vamos começar!*. Você pode optar por não exibir esta página novamente selecionando a caixa de seleção.
...
.Passos
. Baixe e instale o RVTools 4.4.2 ou superior no https://www.dell.com/en-us/shop/vmware/sl/rvtools["Site da RVTools"^]
...
+
Consulte o capítulo sobre "parâmetros de linha de comando" no https://www.dell.com/en-us/shop/vmware/sl/rvtools["A documentação do RVTools está disponível na seção Recursos."^] Para mais detalhes.
